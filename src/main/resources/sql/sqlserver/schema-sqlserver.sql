...
(
  ...
  CONSTRAINT fk_feature_app FOREIGN KEY (APP_ID) REFERENCES togglr.app (ID)
);
...
(
  ...
  CONSTRAINT fk_key_app FOREIGN KEY (APP_ID) REFERENCES togglr.app (ID),
...
(
  ...
  CONSTRAINT fk_config_app FOREIGN KEY (APP_ID) REFERENCES togglr.app (ID),
  CONSTRAINT fk_configs_keys FOREIGN KEY (APP_ID, KEY_NAME) REFERENCES togglr.key_names (APP_ID, KEY_NAME),
  CONSTRAINT fk_features_app FOREIGN KEY (FEATURE_ID) REFERENCES togglr.feature (ID)
);
...
(
  ...
  CONSTRAINT fk_admins_app FOREIGN KEY (APP_ID) REFERENCES togglr.app (ID)
);
...
(
  JWT_ID BIGINT PRIMARY KEY IDENTITY(1,1),
